...
def extract_email_data(path, label, source):
    """
    Ekstrak metadata dan body dari file .eml atau .txt
    :param path: direktori folder spam/ham
    :param label: 'spam' atau 'ham'
    :param source: 'enron' atau 'spamassassin'
...
# Path ke folder email kamu (ubah sesuai lokasi folder dataset kamu)
